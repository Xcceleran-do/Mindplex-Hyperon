...
Mindplex-Hyperon fetches Mindplex articles and delegates metadata extraction to
the independently deployed `metadata-extractor2PLN` service. Configure its base
URL and bearer token before using the ingestion form. See
`experiments/ingestion/README.md` for the deployment contract.
