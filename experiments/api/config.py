...
NL2PLN_BASE_URL = os.getenv("NL2PLN_BASE_URL", "http://127.0.0.1:8081")
NL2PLN_API_KEY = os.getenv("NL2PLN_API_KEY", "")
NL2PLN_NAMESPACE = os.getenv("NL2PLN_NAMESPACE", "mindplex")
NL2PLN_TIMEOUT_SECONDS = float(os.getenv("NL2PLN_TIMEOUT_SECONDS", "60"))
