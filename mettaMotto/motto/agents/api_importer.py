...
try:
    ...
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(current_dir)))  # Go up from examples/motto/agents/ to project root
    env_path = os.path.join(project_root, '.env')
    if os.path.exists(env_path):
        load_dotenv(env_path)
    else:
        # Also try .environ file as fallback
        environ_path = os.path.join(project_root, '.environ')
...
try:
    ...
    import os.path
    current_dir = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(current_dir)))  # Go up from tutorial/motto/agents/ to project root
    env_path = os.path.join(project_root, '.env')
    if os.path.exists(env_path):
        load_dotenv(env_path)
    else:
...
try:
    ...
    import os.path
    current_dir = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.dirname(os.path.dirname(current_dir))  # Go up from motto/agents/ to project root
    env_path = os.path.join(project_root, '.env')
    if os.path.exists(env_path):
